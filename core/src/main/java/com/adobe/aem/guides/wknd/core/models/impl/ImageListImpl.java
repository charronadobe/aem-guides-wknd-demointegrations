...
public class ImageListImpl implements ImageList {
    ...
    protected java.util.List<Resource> findPageComponentResources(final Page page, final String slingResourceType,
        ...
        params.put(JcrPropertyPredicateEvaluator.PROPERTY + "." + JcrPropertyPredicateEvaluator.VALUE,
                slingResourceType);
        ...
        final Iterator<Resource> resources = queryBuilder
                .createQuery(PredicateGroup.create(Collections.unmodifiableMap(params)),
